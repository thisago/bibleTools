...
when isMainModule:
  ...
  for abbr in abbreviations:
    ...
    if book == Unknown:
      ...
      echo fmt"view-source:https://bible.ozzuu.com/compare/{abbr}/1/1"
      discard execShellCmd fmt"curl -s https://bible.ozzuu.com/compare/{abbr}/1/1 | grep -e '\/{abbr}\/' -e '\/en_cepher\/'"
      quit()
